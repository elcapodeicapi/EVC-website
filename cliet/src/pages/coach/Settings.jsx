...
const CoachSettings = () => {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-slate-900">Profielinstellingen</h2>
        <p className="text-sm text-slate-500">Houd je begeleidersprofiel up-to-date.</p>
      </div>
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-3xl bg-white p-6 shadow-card">
          <h3 className="text-base font-semibold text-slate-900">Persoonsgegevens</h3>
          <div className="mt-4 space-y-3 text-sm text-slate-600">
            <label className="flex flex-col gap-1">
              <span className="text-xs uppercase tracking-wide text-slate-400">Weergavenaam</span>
              <input
            ...
            <label className="flex flex-col gap-1">
              <span className="text-xs uppercase tracking-wide text-slate-400">E-mailadres</span>
              <input
        ...
        <section className="rounded-3xl bg-white p-6 shadow-card">
          ...
          <p className="mt-2 text-sm text-slate-500">Wijzig je wachtwoord of schakel tweestapsverificatie in.</p>
      ...
      <section className="rounded-3xl bg-white p-6 shadow-card">
        ...
        <p className="mt-2 text-sm text-slate-500">Geef aan wanneer je doorgaans uploads beoordeelt of begeleidingsgesprekken voert.</p>
        <textarea
          rows={4}
          placeholder="Bijv. Feedback op dinsdag en donderdag, 14:00 - 16:00"
